...
public class PredictorTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PredictorTest.class);

    @Test
    public void testPredictionXGB_v09() throws IOException {
        Predictor p = new Predictor(getClass().getResourceAsStream("/models/xgboost/pi-xgb-v09.model"));
